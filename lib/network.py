...
def weight_init_fun_kaiming (m):
    ...
    if isinstance (m, nn.Linear) or isinstance (m, nn.Conv2d):
        # hyhwang nn.init.kaiming_uniform => nn.init.kaiming_uniform_
