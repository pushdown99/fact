...
class visual_genome (data.Dataset):
  def __init__ (self, opts, image_set='train', dataset_option='normal', batch_size=1, use_region=False):
    #print ('[+] visual_genome_loader __init__ called')
    ...
    ann_file_name = {'vg_normal_train': 'train.json', 'vg_normal_test': 'test.json', 'vg_small_train': 'train_small.json',
               'vg_small_test': 'test_small.json', 'vg_fat_train': 'train_fat.json', 'vg_fat_test': 'test_small.json'}
  ...
  def __getitem__ (self, index):
    #print ('[+] visual_genome_loader __getitem__ called # {}'.format (index))
